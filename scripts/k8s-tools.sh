...
#     https://github.com/mjbright/k8s-scenarios/blob/master/scripts/k8s-tools.sh
# using:
#     wget https://raw.githubusercontent.com/mjbright/k8s-scenarios/master/scripts/k8s-tools.sh

die() { die "$0: - $*" >&2; exit 1; }

die "TODO: this is a placeholder for now"

# TODO:
# add options to install/setup:
#
# mkdir ~/bin ~/src
#
# apt-get install:
...
#
# pip install:
# - jupyter + bash_kernel + jupytext + jupyterlab
# - kubernetes
# - rich
#
# git clone: to ~/src
#      https://github.com/mjbright/k8s-scenarios
#      https://github.com/mjbright/k1spy => copy k1s.py to ~/bin
#
# other tools:
# - install krew
